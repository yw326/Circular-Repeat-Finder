...
////            printf("%d [", merged_list->arrs[i].size);
////            for (int j = 0; j < merged_list->arrs[i].size; j++) {
////                printf("%d",merged_list->arrs[i].arr[j]);
////            }
////            printf("]\n");
////        }
////    }
...
////    treenode_t* s[len*2];
////    treenode_t* q[len*2];
//    treenode_t **s = malloc(sizeof(treenode_t*)*len*2);
//    treenode_t **q = malloc(sizeof(treenode_t*)*len*2);
//
//    int len_q = 1;
//    int len_s = 0;
//    q[0] = root;
...
//            while (child != NULL) {
//
//                // memory bug temporary fix
//                int num_children = numberOfChildren(child);
//                if (num_children <= 1 || num_children > linked_list_num) {
//                    break;
//                }
//
...
//                left_char_value = 0;
//            } else {
//                left_char_value = convertCharToInt(str[start - 1]);
//            }
//
//
//
...
//            node->node_dic[left_char_value].end = NULL;
//
//            if (left_char_value == 0) {
//                printf("data %d\n",node->node_dic[left_char_value].start->data);
//            }
//
//            if (len_s == 23715022) {
//                printf("f3\n");
...
//                if (len_s == 23715022) {
//                    printf("--------\n");
//                    printDictionaryInfo(first_child, linked_list_num);
//                }
//                for (int n = 0; n < linked_list_num; n++) {
//                    children_lists[m][n].start = first_child->node_dic[n].start;
//                    children_lists[m][n].end = first_child->node_dic[n].end;
...
//            for (int m = 0; m < number_of_children; m++) {
//                if (len_s == 23715022) {
//                    printf("children list 1\n");
//                    for(int i = 0; i < linked_list_num; i++) {
//                        print_linkedlist(children_lists[0][i].start);
//                    }
//
//                    printf("children list 2\n");
//                    for(int i = 0; i < linked_list_num; i++) {
//                        print_linkedlist(children_lists[1][i].start);
//                    }
//
//                    printf("f4.3\n");
//                    debug_cnt = 1;
    ...
    while (len_s != 0) {
        ...
        if (str_len < threshold) {
            ...
            while (child != NULL) {
                ...
                int num_chd = numberOfChildren(child);
                if (num_chd == 1 || num_chd > linked_list_num || num_chd < 0) {
                    break;
                }
